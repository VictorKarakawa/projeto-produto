...
export declare namespace AccessTargetDetails {
    function getJsonObj(obj: AccessTargetDetails): object;
    function getDeserializedJsonObj(obj: AccessTargetDetails): object;
}
